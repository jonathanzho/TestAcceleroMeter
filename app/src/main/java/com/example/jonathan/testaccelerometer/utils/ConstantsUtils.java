...
public class ConstantsUtils {
  ...
  public static final int CHECK_PHONE_FACE_STATE_MAX_TRIALS = 5;

  public static final long CHECK_WIFI_ENABLED_SLEEP_MILLIS = 1000;
  public static final int CHECK_WIFI_ENABLED_MAX_TRIALS = 5;

  public static final int FACE_DOWN_WIFI_CONNECTION_JOB_ID = 1;    // Must be unique among all packages of the same uid.
  public static final int FACE_DOWN_WIFI_CONNECTION_OVERRIDE_DEADLINE_MILLIS = 5000;
